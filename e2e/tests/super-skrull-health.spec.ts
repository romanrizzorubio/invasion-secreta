...
test.describe('Test E2E: Los valores de la vida del Súper Skrull se generan correctamente', () => {
  test('Flujo completo con 2 mesas (Normal y Experto) y 4 jugadores cada una', async ({ browser }) => {
    ...
    const timeValue = endTime.toLocaleTimeString('es-ES', { hour: '2-digit', minute: '2-digit', hour12: false });
